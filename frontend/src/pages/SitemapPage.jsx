...
const SitemapPage = () => {
  ...
  return (
    <>
      <SEO 
        title="Plan du site"
        description="Explorez facilement toutes les pages et fonctionnalités de LexForge grâce à notre plan du site. Accédez directement aux générateurs de contrats juridiques et aux ressources disponibles."
        keywords="plan du site, sitemap, navigation, lexforge, pages, structure du site, carte du site, index, contrats disponibles"
        canonical="https://www.lexforge.fr/plan-site"
      />
